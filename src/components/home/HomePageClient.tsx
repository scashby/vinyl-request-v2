...
// Client half of the home page: `sections` (the editable marketing copy)
// arrives already resolved from the server (see src/app/page.tsx) so it
// renders correctly on the first paint — no flash. Events and Dialogues
// posts change often enough, and are cheap enough to show a loading state
// for, that they stay fetched here after mount rather than server-resolved.

"use client";

import { useEffect, useMemo, useState } from "react";
import { supabase } from "src/lib/supabaseClient";
import { residencySeasonLabel, type HomepageSection, type ResidencyTokens, type resolveSections } from "src/lib/homeContent";
...
export function HomePageClient({ sections: s }: { sections: ReturnType<typeof resolveSections> }) {
