...
export const gameBlueprints: GameBlueprint[] = [
  ...
  },
  {
    ...
    pullSizeGuidance: "Question deck target: rounds x questions per round + 3 tie-breakers; record pulls optional.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Snippet deck target: rounds + 20% backup (minimum +2 backup snippets).",
  ...
  },
  {
    ...
    pullSizeGuidance: "Bracket track target: bracket_size matchups + 2 tie-break tracks.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Needle-drop deck target: rounds + 2 backup drops.",
    scoring: "2 points for artist+title, 1 for either one.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Lyric gap deck target: rounds + 2 backup gaps.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Round pack target: rounds + 1 spare round (3 records per round).",
  ...
  },
  {
    ...
    pullSizeGuidance: "Decade call target: rounds + 1-2 tie-break records.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Reveal deck target: rounds + 2 backup art/audio clues.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Category pull target: rounds x 3-5 tracks + 1 spare category pack.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Lyric option set target: rounds + 2 tie-break sets.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Sample-source pair target: rounds + 1-2 backup pairs.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Clue card target: rounds + 2 backup cards/audio fallbacks.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Original/cover pair target: rounds + 2 quick-swap backup pairs.",
  ...
  },
  {
    ...
    pullSizeGuidance: "Connection pair target: rounds + 1 tie-break pair (2 records per pair).",
  ...
  },
  {
    ...
    pullSizeGuidance: "Era trio target: rounds + 1 backup trio.",
...
export const getGameBuildPrompt = (game: GameBlueprint): string => {
  ...
  return [
    ...
    `Setup: ${game.setup}`,
    `Playlist/crate pull target: ${game.pullSizeGuidance}`,
