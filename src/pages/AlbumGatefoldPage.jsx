...
const dummyAlbum = {
  ...
  sides: [
    { label: 'A', tracks: ['Hotel California', 'New Kid in Town', 'Life in the Fast Lane', 'Wasted Time'] },
    { label: 'B', tracks: ['Wasted Time (Reprise)', 'Victim of Love', 'Pretty Maids All in a Row', 'Try and Love Again', 'The Last Resort'] }
  ]
};

const AlbumGatefoldPage = () => {
  return <AlbumGatefoldCard album={dummyAlbum} />;
};
