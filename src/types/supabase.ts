  ...
  public: {
    Tables: {
      ...
      game_session_picks: {
        ...
        Relationships: [
          {
            foreignKeyName: 'game_session_picks_session_id_fkey';
            columns: ['session_id'];
            referencedRelation: 'game_sessions';
            referencedColumns: ['id'];
          },
          {
            foreignKeyName: 'game_session_picks_template_item_id_fkey';
            columns: ['template_item_id'];
            referencedRelation: 'game_template_items';
            referencedColumns: ['id'];
          }
        ];
      };
      game_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'game_sessions_template_id_fkey';
            columns: ['template_id'];
      ...
      game_template_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'game_template_items_inventory_id_fkey';
            columns: ['inventory_id'];
            referencedRelation: 'inventory';
            referencedColumns: ['id'];
          },
          {
            foreignKeyName: 'game_template_items_recording_id_fkey';
