// src/app/admin/edit-about/page.tsx - Admin interface for editing About page content
      ...
      if (error) {
        if (error.code !== 'PGRST116') {
          ...
          console.error('Error fetching about content:', error);
           ...
           // Handle case where table exists but is empty - initialize default structure
    ...
    <div style={{
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <textarea
          ...
          onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, main_description: e.target.value }) : null)}
          rows={6}
          style={{
            display: 'block',
            width: '100%',
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <textarea
          ...
          onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, booking_description: e.target.value }) : null)}
          rows={3}
          style={{
            display: 'block',
            width: '100%',
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
          <input
            ...
            onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, contact_name: e.target.value }) : null)}
          ...
          <input
            ...
            onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, contact_company: e.target.value }) : null)}
            style={{ padding: '0.5rem', border: '1px solid #ccc', borderRadius: '4px' }}
          />
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
          <input
            ...
            onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, contact_email: e.target.value }) : null)}
            style={{ padding: '0.5rem', border: '1px solid #ccc', borderRadius: '4px' }}
          />
          <input
            type="tel"
            ...
            onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, contact_phone: e.target.value }) : null)}
            style={{ padding: '0.5rem', border: '1px solid #ccc', borderRadius: '4px' }}
          />
        </div>
        <input
          ...
          onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, calendly_url: e.target.value }) : null)}
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <textarea
          ...
          onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, booking_notes: e.target.value }) : null)}
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '0.5rem' }}>
          <input
            ...
            onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, amazon_wishlist_url: e.target.value }) : null)}
            style={{ padding: '0.5rem', border: '1px solid #ccc', borderRadius: '4px' }}
          />
          <input
            type="url"
            ...
            onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, discogs_wantlist_url: e.target.value }) : null)}
            style={{ padding: '0.5rem', border: '1px solid #ccc', borderRadius: '4px' }}
          />
          <input
            type="url"
            ...
            onChange={(e) => setAboutContent(prev => prev ? ({ ...prev, linktree_url: e.target.value }) : null)}
            style={{ padding: '0.5rem', border: '1px solid #ccc', borderRadius: '4px' }}
          />
        </div>
      </div>
