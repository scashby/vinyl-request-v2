    ...
    <div className="min-h-screen bg-[#121212] text-white">
      <header className="sticky top-0 z-20 border-b border-white/10 bg-[#121212]/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          <Link href="/admin/games/vinyl-bingo" className="flex items-center gap-2 text-white/80 hover:text-white">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href={`/admin/games/vinyl-bingo/sidekick?sessionId=${session.id}`} className="rounded-lg border border-white/20 px-3 py-1.5 text-sm text-white/80 hover:bg-white/10">
              <Music2 className="mr-2 inline h-4 w-4" />Assistant
            </Link>
            <Link href={`/admin/games/vinyl-bingo/jumbotron?sessionId=${session.id}`} className="rounded-lg border border-white/20 px-3 py-1.5 text-sm text-white/80 hover:bg-white/10">
