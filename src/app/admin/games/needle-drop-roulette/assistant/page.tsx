      ...
      <div className="mx-auto max-w-4xl rounded-3xl border border-amber-900/50 bg-black/40 p-6">
        ...
        <section className="mt-6 rounded-xl border border-stone-700 bg-stone-950/60 p-4">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-stone-200">
            <li>Optional scorer view for team-by-team correctness toggles and dispute notes.</li>
            <li>Slip collection tracker so host can see when scoring is safe to lock.</li>
            <li>No transport controls; assistant should never drive deck timing.</li>
            <li>Solo-host fallback: merge this scope as a compact scoring drawer in host view.</li>
          </ul>
        </section>
      </div>
    </div>
