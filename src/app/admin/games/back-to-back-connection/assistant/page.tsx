      ...
      <div className="mx-auto max-w-4xl rounded-3xl border border-amber-900/50 bg-black/40 p-6">
        ...
        <section className="mt-6 rounded-xl border border-stone-700 bg-stone-950/60 p-4">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-6 text-sm text-stone-200">
            <li>Optional: input team scores and track dispute notes while host cues next pair.</li>
            <li>No deck transport buttons to keep solo-host fallback clean and deterministic.</li>
            <li>Status-only view for next two upcoming pairs for prep awareness.</li>
          </ul>
        </section>
      </div>
    </div>
