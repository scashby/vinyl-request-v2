      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="rounded-3xl border border-amber-900/40 bg-black/45 p-6">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <label className="text-sm">Connection Points
            ...
            <label className="text-sm">Detail Bonus Points
          ...
          <div className="mt-4 grid gap-2 text-sm md:grid-cols-4">
            ...
            <label className="inline-flex items-center gap-2"><input type="checkbox" checked={showConnectionPrompt} onChange={(e) => setShowConnectionPrompt(e.target.checked)} /> Show connection prompt</label>
          </div>
        </section>
        ...
        <section className="rounded-3xl border border-amber-900/40 bg-black/45 p-6">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <label className="text-sm">Pairs (Track A | Track B | Connection | Optional detail)
          ...
          <div className="mt-4 rounded-xl border border-stone-700 bg-stone-950/80 p-3 text-sm">
            ...
            <div className="mt-2 grid gap-2 md:grid-cols-2">
              <label className="inline-flex items-center gap-2"><input type="checkbox" checked={preflight.pairOrderPrinted} onChange={(e) => setPreflight((p) => ({ ...p, pairOrderPrinted: e.target.checked }))} /> Pair order and answer key printed</label>
              <label className="inline-flex items-center gap-2"><input type="checkbox" checked={preflight.sleevesStagedInPlayOrder} onChange={(e) => setPreflight((p) => ({ ...p, sleevesStagedInPlayOrder: e.target.checked }))} /> Sleeves staged in play order</label>
              <label className="inline-flex items-center gap-2"><input type="checkbox" checked={preflight.tiebreakPairReady} onChange={(e) => setPreflight((p) => ({ ...p, tiebreakPairReady: e.target.checked }))} /> Tie-break pair staged and labeled</label>
            </div>
          </div>
