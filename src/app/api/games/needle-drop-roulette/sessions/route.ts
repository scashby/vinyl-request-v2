...
export async function GET(request: NextRequest) {
  ...
  let query = db
    .from("ndr_sessions")
    .select("id, event_id, playlist_id, session_code, title, round_count, answer_mode, snippet_seconds, status, current_round, created_at")
  ...
  try {
    ...
    const { data: session, error: sessionError } = await db
      ...
      .insert({
        ...
        welcome_heading_text: body.welcome_heading_text ?? "Welcome to Needle Drop Roulette",
        welcome_message_text: body.welcome_message_text ?? "Get your team ready for the next drop.",
        intermission_heading_text: body.intermission_heading_text ?? "Intermission",
        intermission_message_text: body.intermission_message_text ?? "Quick reset. Next drop starts soon.",
