    ...
    const { data: session, error: sessionError } = await db
      ...
      .insert({
        ...
        show_options: body.show_options ?? true,
          ...
          welcome_heading_text: body.welcome_heading_text ?? 'Welcome to Wrong Lyric Challenge',
          welcome_message_text: body.welcome_message_text ?? 'Spot the incorrect lyric.',
