  ...
  try {
    ...
    const { data: session, error: sessionError } = await db
      ...
      .insert({
        ...
        welcome_heading_text: body.welcome_heading_text ?? 'Welcome to Bracket Battle',
        welcome_message_text: body.welcome_message_text ?? 'Vote for your favourite track in each matchup to advance seeds through the bracket.',
